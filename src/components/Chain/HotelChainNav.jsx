      ...
      <div className="flex justify-between items-center gap-3 font-body">
        ...
        >
          <div className="lg:hidden h-[22px] w-[22px] flex flex-col gap-1.5 items-center justify-center">
            ...
            ></div>
            <div
              className={`w-full h-[2px] bg-headingColor ${
                toggle && "opacity-0"
              }`}
            ></div>
            <div
        ...
        <div>
          <div className="hidden lg:flex border-b pb-2 border-bodyColor border-opacity-30">
            <ul className="flex text-sm text-bodyColor pb-2 pt-4">
              <li className="px-3 hover:text-beautifulBlue duration-200">
                <div className="hs-dropdown [--placement:bottom-right] relative inline-flex">
                  ...
                  <div
                    className="z-20 hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-[10rem] bg-white shadow-2xl rounded-lg p-2 mt-2 after:h-4 after:absolute after:-bottom-4 after:start-0 after:w-full before:h-4 before:absolute before:-top-4 before:start-0 before:w-full"
                    aria-labelledby="hs-dropdown-default"
                  >
                    <a
                      className="flex items-center gap-2 py-2 px-3 rounded-lg text-base text-bodyColor hover:bg-beautifulBlue hover:bg-opacity-10 hover:text-beautifulBlue duration-300 focus:outline-none"
                      href="#"
                    >
                      <img src="../../../src/img/uk.svg" className="w-5 h-5" />
                      English
                    </a>
                    <a
                      className="flex items-center gap-2 py-2 px-3 rounded-lg text-base text-bodyColor hover:bg-beautifulBlue hover:bg-opacity-10 hover:text-beautifulBlue duration-300 focus:outline-none"
                      href="#"
                    >
                      <img src="../../../src/img/sp.svg" className="w-5 h-5" />
                      Espanol
                    </a>
                    <a
                      className="flex items-center gap-2 py-2 px-3 rounded-lg text-base text-bodyColor hover:bg-beautifulBlue hover:bg-opacity-10 hover:text-beautifulBlue duration-300 focus:outline-none"
                      href="#"
                    >
                      <img src="../../../src/img/fr.svg" className="w-5 h-5" />
                      Francis
                    </a>
                    <a
                      className="flex items-center gap-2 py-2 px-3 rounded-lg text-base text-bodyColor hover:bg-beautifulBlue hover:bg-opacity-10 hover:text-beautifulBlue duration-300 focus:outline-none"
                      href="#"
                    >
                      <img src="../../../src/img/gr.svg" className="w-5 h-5" />
                      Deutsch
                    </a>
                  </div>
                </div>
              ...
              <li className="px-3 hover:text-beautifulBlue duration-200">
                <div className="hs-dropdown [--placement:bottom-right] relative inline-flex">
                  ...
                  <div
                    className="z-10 hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-[5rem] bg-white shadow-2xl rounded-lg px-3 py-4 mt-2 after:h-4 after:absolute after:-bottom-4 after:start-0 after:w-full before:h-4 before:absolute before:-top-4 before:start-0 before:w-full"
                    aria-labelledby="hs-dropdown-default"
                  >
                    <a
                      className="group flex items-center gap-2 py-2 px-3 rounded-lg text-base text-bodyColor hover:bg-beautifulBlue hover:bg-opacity-10 hover:text-beautifulBlue duration-300 focus:outline-none"
                      href="#"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="flex flex-row gap-3 justify-end items-center overflow-hidden">
            {toggle ? (
              <ul className="absolute left-0 top-[90%] z-10 bg-white rounded-md w-full lg:w-fit text-base lg:static lg:flex ">
                <li className="group cursor-pointer">
                  ...
                  <div className="opacity-0 group-hover:opacity-100 pointer-events-none group-hover:pointer-events-auto duration-300 absolute left-0 right-0 z-10 max-w-full mx-auto bg-white shadow-2xl p-6 rounded-lg overflow-y-scroll h-[300px] lg:h-auto lg:overflow-hidden">
                    <div className="flex flex-col lg:flex-row lg:gap-20">
                      {/* first Group */}
                      <div className="w-full lg:w-6/12">
                        <h6 className="flex gap-2 items-center font-bold">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width={16}
                            height={16}
                            className="bi bi-pin-map-fill fill-beautifulBlue"
                            viewBox="0 0 16 16"
                          >
                            <path
                              fillRule="evenodd"
                      ...
                      <div className="w-full lg:w-3/12">
                        <h6 className="flex gap-2 items-center font-bold">
                          <svg
                            ...
                            width={16}
                            height={16}
                            className="bi bi-list-task fill-beautifulBlue"
                            viewBox="0 0 16 16"
                          >
                            <path
                              fillRule="evenodd"
                      ...
                      <div className="w-full lg:w-3/12">
                        <h6 className="flex gap-2 items-center font-bold">
                          <svg
                            ...
                            height={16}
                            fill="currentColor"
                            className="bi bi-grid-3x3-gap fill-beautifulBlue"
                            viewBox="0 0 16 16"
                          >
                    ...
                    <div className="relative mt-[25px] bg-[url('../../../src/img/headerBg.jpg')] bg-cover bg-left md:h-[180px] rounded-xl overflow-hidden  lg:h-[97px]">
                      ...
                      <div className="relative z-20 w-full max-h-full p-5 flex lg:flex-row flex-col justify-center items-start gap-4 lg:justify-between lg:items-center">
                        <div>
                          <h5 className="text-white mb-2 lg:mb-1">
                        ...
                        <a
                          className="font-body bg-white border-white border text-headingColor font-bold tracking-widest px-5 py-2 text-md rounded-md"
                          href="#"
                        >
                          Register Now
                        </a>
            ...
            <ul className="hidden absolute left-0 top-[90%] z-10 bg-white rounded-md w-full lg:w-fit text-base lg:static lg:flex ">
              <li className="group cursor-pointer">
                <div className="p-4 flex justify-between lg:justify-start lg:gap-[6px] items-center hover:text-beautifulBlue duration-200">
                  <a href="#">Find a hotel</a>
                  <svg
            ...
            <div className="hs-dropdown relative inline-flex">
              <button
                ...
                type="button"
                className="hs-dropdown-toggle font-body bg-beautifulBlue border-beautifulBlue border text-white font-bold text-[13px] tracking-widest px-3 py-[6px] rounded-md flex gap-1 items-center"
              >
                Book stay
                <svg
              ...
              <div
                className="z-10 hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-[22rem] bg-white shadow-2xl rounded-lg mt-2  after:h-4 after:absolute after:-bottom-4 after:start-0 after:w-full before:h-4 before:absolute before:-top-4 before:start-0 before:w-full"
                aria-labelledby="hs-dropdown-auto-close-outside"
              >
                <h6 className="font-heading px-6 font-bold text-headingColor py-4">
                  Search your Destination
                </h6>
                <hr />
                <div className="px-6 py-4 flex flex-col gap-5">
                  <div>
                    <label className="text-bodyColor" htmlFor="location">
                      Hotel or Destination
                    </label>
                    <select className="py-3 px-3 block w-full border-someGray bg-someGray text-bodyColor rounded-lg focus-visible:outline-none disabled:opacity-50 disabled:pointer-events-none">
                  ...
                  <div className="flex gap-4 text-bodyColor">
                    <div className="flex flex-col max-w-[150px]">
                      ...
                      <input
                        ...
                        className="bg-someGray py-3 px-4 rounded-md"
                      />
                    </div>
                    <div className="flex flex-col max-w-[150px]">
                  ...
                  <div className="flex flex-col gap-1">
                    <label className="text-bodyColor" htmlFor="#">
                      Guests & rooms
                    </label>
                    <input
                      type="text"
                  ...
                  <a className="underline text-bodyColor text-center" href="#">
                    Have a promo code?
                  </a>

                  <button className="text-beautifulBlue bg-beautifulBlue bg-opacity-10 py-2 rounded-md hover:bg-beautifulBlue hover:text-white duration-300 font-bold tracking-wider">
                    Check Availability
                  </button>
                </div>
              </div>
