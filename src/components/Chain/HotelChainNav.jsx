...
const HotelChainNav = () => {
  ...
  return (
    <header className="bg-white dark:bg-bgDarkModeColor py-3">
      <nav className="container">
        <div className="flex justify-between items-center">
          ...
          <div className="flex lg:flex-col gap-3 font-body">
            {/* hamburger menu */}
            <div
              onClick={handleToggle}
              className="hs-collapse-toggle flex items-center gap-2 cursor-pointer"
              data-hs-collapse="#menuItems"
            >
            ...
            <div className="hidden lg:flex border-b border-bodyColor border-opacity-30">
              <ul className="flex text-sm text-bodyColor dark:text-grayPara pb-2 pt-4">
                <li className="px-3 z-40 hover:text-beautifulBlue dark:hover:text-darkModeBlue duration-200">
                  <div className="hs-dropdown z-40 [--placement:bottom-right] relative inline-flex">
                    ...
                    <div
                      className="z-40 hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-[10rem] bg-white dark:bg-cardDarkModeColor shadow-2xl rounded-lg p-2 mt-2 after:h-4 after:absolute after:-bottom-4 after:start-0 after:w-full before:h-4 before:absolute before:-top-4 before:start-0 before:w-full"
            ...
            <div className="flex gap-3 items-center lg:ml-6">
              ...
              <div
                id="menuItems"
                className="hs-collapse hidden lg:flex w-full lg:w-fit lg:static overflow-hidden transition-[height] duration-300 absolute top-16 left-0 z-10 bg-white dark:bg-bgDarkModeColor"
              >
                <div className="hs-dropdown [--auto-close:inside] [--strategy:static] xl:[--strategy:fixed] [--adaptive:none] w-full lg:w-fit [--placement:bottom-left]">
                  <div
                    id="dropdown1"
                    type="button"
                    className="hs-dropdown-toggle hover:text-beautifulBlue dark:hover:text-darkModeBlue inline-flex w-full px-6 py-3 lg:px-3 lg:p-0 justify-between items-center gap-x-2"
                  >
                    <a
                      className="text-headingColor dark:text-grayPara dark:hover:text-darkModeBlue hover:text-beautifulBlue"
                      href="#"
                    >
                      Find a hotel
                    </a>
                  ...
                  >
                    <div className="border bg-white lg:shadow-md dark:bg-cardDarkModeColor lg:mx-0 dark:border-none lg:border-none p-8 mx-4 rounded-lg lg:-translate-x-16 lg:w-[1224px]">
                      ...
                      {/* Fourth Group */}
                      <div className="relative mt-[25px] bg-[url('./header-bg.jpg')] bg-cover bg-left md:h-[180px] rounded-xl overflow-hidden  lg:h-[97px]">
                        ...
                        <div className="relative z-20 w-full max-h-full p-5 flex lg:flex-row flex-col justify-center items-start gap-4 lg:justify-between lg:items-center">
                          <div>
                            ...
                            <ul className="flex gap-x-4 gap-1 flex-wrap text-white text-sm lg:text-base">
                ...
                <div className="hs-dropdown [--auto-close:inside] [--strategy:static] xl:[--strategy:fixed] [--adaptive:none] w-full lg:w-fit">
                  <div
                    id="dropdown2"
                    type="button"
                  ...
                  <div
                    className="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 max-w-full lg:max-w-[280px] rounded-lg lg:shadow-md hidden z-10 w-full bg-white dark:bg-bgDarkModeColor lg:dark:bg-cardDarkModeColor"
                    aria-labelledby="dropdown2"
                  >
                    <div className="border bg-white dark:bg-cardDarkModeColor dark:border-none lg:border-none p-4 mx-6 lg:mx-0 my-1 rounded-lg">
