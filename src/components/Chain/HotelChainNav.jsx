            ...
            <ul className="flex text-sm text-bodyColor pb-2 pt-4">
              <li className="px-3 hover:text-beautifulBlue duration-200">
                <div className="hs-dropdown [--placement:bottom-right] relative inline-flex">
                  ...
                  <div
                    className="z-10 hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-[10rem] bg-white shadow-2xl rounded-lg p-2 mt-2 after:h-4 after:absolute after:-bottom-4 after:start-0 after:w-full before:h-4 before:absolute before:-top-4 before:start-0 before:w-full"
