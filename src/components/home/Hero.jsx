...
import GuestAndRoom from "./GuestAndRoom";
        ...
        <div className="grid grid-cols-12 gap-y-10 mx-auto md:w-3/4 lg:w-auto lg:gap-y-0 lg:gap-x-20">
          <div className="col-span-12 lg:col-span-6">
            <div className="lg:mt-5 xl:mt-12">
              ...
              <p className="text-gray-500 dark:text-gray-300 mb-5 xl:mb-6">
                We bring you not only a stay option, but an experience in your
                budget to enjoy the luxury.
              </p>
              <div className="flex flex-col items-start gap-y-5 md:gap-y-0 md:gap-x-6 md:flex-row md:items-center">
                <a
                  href="#!"
                  className="inline-block font-bold py-2 px-4 tracking-[0.5px] rounded-lg text-blue-500 bg-blue-500/[0.1] border border-blue-500/[0.1] duration-300 hover:text-white hover:bg-blue-500 hover:border-blue-500 active:bg-transparent active:text-gray-500 active:border-gray-900 dark:text-blue-300 dark:hover:bg-blue-300"
                >
                  Discover Now
                </a>
                <div className="">
                  <a
                    href="https://www.youtube.com/watch?v=tXHviS-4ygo"
                    className="glightbox"
                  >
                    <div className="flex items-center gap-x-3 font-semibold text-sm text-gray-800 dark:text-gray-100">
                      <div className="relative">
                        <img
                          src="./12.jpg"
                          className="w-8 h-8 object-cover origin-center rounded-full md:w-12 md:h-12"
                          alt=""
                        />
                        <span className="absolute top-0 w-full h-full flex justify-center items-center">
                          <span className="bg-white rounded-full p-2 duration-100 hover:bg-gray-200">
                            <FaPlay className="w-1.5 h-1.5 dark:text-gray-900 md:w-2.5 md:h-2.5" />
                          </span>
                        </span>
                      </div>
                      Watch Our Story
          ...
          <div className="col-span-12 lg:col-span-6">
            <div className="relative">
              <img src="./06.jpg" className="w-full rounded-xl" alt="" />
              <img
                src="./11.jpg"
                className="absolute left-0 -translate-x-1/2 top-7 w-14 h-14 object-cover origin-center rounded-full border-[3px] border-white dark:border-body-dark hidden md:block"
                alt=""
              />
              <img
                src="./1.jpg"
                className="absolute left-0 -translate-x-1/2 top-32 w-20 h-20 object-cover origin-center rounded-full border-[3px] border-white dark:border-body-dark hidden md:block"
                alt=""
              />
              <div className="absolute top-0 right-0 -translate-y-5 backdrop-blur-sm p-5 pt-6 bg-white/30 rounded-2xl flex flex-col items-center shadow-md md:translate-x-5">
                <BsHeadset className="text-red-500 text-4xl mb-1" />
                <h3 className="text-xl font-bold mb-1">24 / 7</h3>
                <p className="text-sm">Guide Supports</p>
              </div>
              <div className="absolute bottom-5 right-0 md:-right-5">
          ...
          <div className="col-span-12 -mt-44">
            <div className="lg:w-[90%] xl:w-[85%]">
              <h3 className="text-lg font-bold mb-3 dark:text-gray-100">
                Check Availability
              </h3>
              <div className="grid grid-cols-12 bg-white shadow-md py-8 pb-14 px-4 rounded-2xl relative gap-y-8 md:gap-x-8 lg:gap-y-0 dark:bg-dark md:px-10 md:py-8 md:pr-16">
                <div className="flex items-center gap-x-3 col-span-12 lg:col-span-4">
                  <BsGeoAlt className="w-6 h-6 text-gray-500 lg:w-9 lg:h-9" />
                  <LocationSelect />
                </div>
                <div className="flex items-center gap-x-3 col-span-12 lg:col-span-4">
                  <FaRegCalendar className="w-6 h-6 text-gray-500 lg:w-9 lg:h-9" />
                  <DatePicker />
                </div>
                <div className="flex items-center gap-x-3 col-span-12 lg:col-span-4">
                  <FaRegUser className="w-6 h-6 text-gray-500 lg:w-9 lg:h-9" />
                  <GuestAndRoom />
                </div>
                <div className=" absolute flex items-center w-full justify-center bottom-0 translate-y-1/2 md:translate-y-0 md:translate-x-1/2 md:w-auto md:h-full md:right-0 md:top-0">
                  <button className="p-4 rounded-full bg-blue-500 text-white md:p-5 dark:bg-blue-300">
                    <FaMagnifyingGlass className="w-4 md:w-5 h-4 md:h-5" />
                  </button>
                </div>
              </div>
            </div>
