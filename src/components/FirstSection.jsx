...
const FirstSection = () => {
  return (
    <section className="container">
      <div className="my-20">
        <h1 className="text-4xl md:text-[40px] lg:text-[56px] max-w-[90%] text-start font-bold font-heading dark:text-white text-headingColor mb-4 leading-tight md:mr-0 mr-10">
      ...
      <div className="grid grid-cols-1 justify-center md:grid-cols-2 lg:grid-cols-3 gap-6 my-5">
        <div className=" md:col-span-1 py-5 px-auto flex flex-col items-center gap-2 dark:bg-gray-950 rounded-2xl shadow-md shadow-blue">
        ...
        <div className=" relative  md:col-span-2 lg:col-span-1 py-5 px-auto flex flex-col items-center gap-2 dark:bg-gray-950 rounded-2xl shadow-md shadow-blue">
          <svg
